...
////[@id="title-search"]/input[2] - лучше //[@id="title-search"]/input[@type='submit'] , так как индексирование по номеру не надежно
//
//Вместо локатора //[@id="root_picture_carousel"]/div[1]/div/div/div[3]/a/img лучше //[@id="root_picture_carousel"]//img[contains(@alt,'Moon')]
